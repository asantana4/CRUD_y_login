...
public class ControladorSec implements ActionListener {
    ...
    SeccionesVista vista = new SeccionesVista();
    DefaultTableModel modelo = new DefaultTableModel();

    public ControladorSec(SeccionesVista v) {
        this.vista = v;
...
//                this.vista.btnCancelar.setEnabled(true);
    ...
    void limpiarTabla() {
     ...
     public final void limpiarCampos(SeccionesVista v) {
        v.txtID.setText("");
        v.txtClave.setText("");
     ...
     public void buscarFila(JTable tabla) {
      ...
      public int validarCampos(SeccionesVista v) {
