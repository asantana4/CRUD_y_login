...
public class ControladorProf implements ActionListener {
    ...
    ProfesoresVista vista = new ProfesoresVista();
    DefaultTableModel modelo = new DefaultTableModel();

    public ControladorProf(ProfesoresVista v) {
        this.vista = v;
...
//            limpiarTabla();
    ...
    void limpiarTabla() {
     ...
     public final void limpiarCampos(ProfesoresVista v) {
        v.txtID.setText("");
        v.txtNombre.setText("");
     ...
     public void buscarFila(JTable tabla) {
      ...
      public int validarCampos(ProfesoresVista v) {
